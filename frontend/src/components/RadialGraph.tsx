...
export function RadialGraph({ borrower, canvasWidth, canvasHeight, onMetricClick }: RadialGraphProps) {
  ...
  return (
    ...
    >
      ...
      {/* Background */}
      <rect x={0} y={0} width={canvasWidth} height={canvasHeight} fill="var(--color-bg)" />
      <rect x={0} y={0} width={canvasWidth} height={canvasHeight} fill={`url(#${uid}dp)`} />
